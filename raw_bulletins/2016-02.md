...
*NOTE: For February, F2A numbers EXEMPT from per-country limit are authorized for issuance to applicants from all countries with priority dates earlier than 08JUN14. F2A numbers SUBJECT to per-country limit are authorized for issuance to applicants chargeable to all countries EXCEPT MEXICO with priority dates beginning 08JUN14 and earlier than 01SEP14. (All F2A numbers provided for MEXICO are exempt from the per-country limit; there are no F2A numbers for MEXICO subject to per-country limit.)
