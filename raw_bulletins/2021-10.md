...
[View as Printer Friendly PDF](https://travel.state.gov/content/dam/visas/Bulletins/visabulletin_october2021.pdf)
...
| 5th Non-Regional Center  (C5 and T5) | C | 22NOV15 | C | C | C | C |
...
NOTE: This month's Employment-Based tables did not include a VIETNAM column and did not include the fourth preference "Certain Religious Workers" as C/A entries in the final action dates chart being separate from the "4th" row values (see raw data above for exact rendering).
